...
export default class ModalDropdown extends Component {
    ...
    _renderButton() {
        ...
        const {buttonText, showMinus} = this.state;
        const arrow = showMinus ? Images.minus : Images.plus;
            ...
            >
                {
                    ...
                    (
                        <View style={styles.button}>
                            ...
                            <Image source={arrow}
                                   style={{tintColor: 'black', height: 20, width: 20, marginTop: 2, marginBottom: 3}}
                                   resizeMode="contain"/>
                        </View>
                    )
                }
